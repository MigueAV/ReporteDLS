...
<script type="text/javascript">
    $(document).ready(function () {
        document.getElementById("codusuid").focus({preventScroll:true});
        obtenerperfiles();
    });
         ...
         <div class="flat" style="border-color:black;border:solid;border-radius: 20px 20px 50px 30px;-webkit-border-radius: 20px 20px 50px 30px;-moz-border-radius: 20px 20px 50px 30px;">
            ...
            <div class="tab-content">
                ...
                <div id="registro" class="container tab-pane fade"><br>
                    <button class="btn btn-primary btn-sm" type="button" id="crear_usuario" style="float:right;display:none;" data-toggle="modal" data-target="#myModalUsuario"  >NUEVO</button><h3 style="color:white;">REGISTRO</h3>
