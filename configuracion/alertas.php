...
<div class="modal fade" tabindex="-1" role="dialog" id="modalMensaje">
  <div class="modal-dialog modal-dialog-centered" role="document" style="max-width:600px">
    <div class="modal-content" >
      ...
      <div class="modal-body" style="padding-top:5px;padding-bottom:15px;" >
      ...
      <div class="modal-footer" style="text-align:center;float:middle;justify-content: center;padding-top:0;padding-bottom:0;">
        <button type="button" id="cierremensaje" class="btn btn-sm btn-outline-dark focus" style="text-align:center;float:middle;"  autofocus data-dismiss="modal">ACEPTAR</button>
      </div>
    </div>
  </div>
</div>
